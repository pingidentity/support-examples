...
{
    if(document.getElementById('SpSessionAuthnAdapterId') != null) {
		if(document.getElementById('SpSessionAuthnAdapterId').value != "") {
			url += "&SpSessionAuthnAdapterId=";
			url += document.getElementById('SpSessionAuthnAdapterId').value;
		}
	}
